...
[string]$global:error_projects_empty = "The 'projects' property of the configuration file is empty. You must provide at least one complete project object before running the script again."